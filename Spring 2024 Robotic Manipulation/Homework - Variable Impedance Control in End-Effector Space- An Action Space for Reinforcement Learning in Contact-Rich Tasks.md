...
## Problem Definition
Robotic manipulation in RL has focused on the observation space or reward model rather than action space.  can simplify the exploration and improve robustness. However, choosing 