...
- One famous example is from Nature journal, called Mastering the game of Go without human knowledge. AlphaGo is trained solely on reinforcement learning without human data with just rules of the game
