...
TAMP is capable of performing tasks in complex environments with obstacles, such as determining if path or action is feasible, manipulating objects with collision avoidance, and 
