...
RL is very useful to synthesize optimal or robust policy in the unknown environment. Especially, task involving multi-contact which suffers from precise modeling can be  
