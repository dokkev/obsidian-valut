...
- Recent robot data collection hardware such as mobile aloha and Universal Manipulation Interface from Stanford showed impressive results of policy learning with simple teleop interfaces 
