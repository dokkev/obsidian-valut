...
Although the paper includes comparison of evaluations with SD/FAST, it lacks of comparison to other simulators such as Bullet or ODE. In addition, the performance evaluation focuses on numerical optimization speed rather than accuracy; It does not validate with comparing to real-world experiments